...
*Einsatz auf Kundenseite (cust) f�r das (Initialisierungs)-Element in der Menge set_t_ini
...
*Uebergabe der Energiefluesse im Rahmen des Initialierungszeitschritts des Optimierungshorizonts
*Energieflussvariable wird durch den initial definierten bzw. bestimmten Energiefluss festgelegt
*Einsatz auf Unternehmensseite (orga) f�r das (Initialisierungs)-Element in der Menge set_t_ini
...
EQUATIONS EqEY8_DES(set_ii,set_pss) Restriktion maximale Kapazit�t Stromaufnahme negative Regelenergie Durchlauferhitzer;
...
*Negative Regelenergie ist kleiner als die maximale elektrische Leistung der Anlage minus der genutzten Elektrischen Leistung, also dem Zufluss der Anlage
EQUATIONS EqEY9_DES(set_ii,set_pss) Restriktion maximale Kapazit�t Stromaufnahme positiver Regelenergie Durchlauferhitzer;
...
EQUATIONS EqEY10_DES(set_ii,set_pss) Restriktion maximaler W�rmeabfluss negative Regelenergie Durchlauferhitzer;
...
*Ausk�hlungsverhalten beim Abschalten des Kraftwerks
*var_heating_pss: Beschreibung der relative Statusvariable in Form der ben�tigten Mehrenergie beim Hochfahren des ausgek�hlten Produktionsanlage
*Formeln von Silbernagel et al. 2016 Improving Accuracy and Efficiency of Start-Up Cost Fomulations in MIP Unit Commitment
...
Equation EqEY15_DES(set_ii_0,set_pss) Initiale Operationale Temperaturver�nderung (Equation 23 Silbernagl et al. 2015);
...
*Mindestbetriebszeit
*Kraftwerksbezogene dynamische Sets f�r den Optimierungsdurchlauf definieren und initialisieren
...
Equation EqEY23_DES(set_ii_0,set_pss) Kraftwerksverf�gbarkeit;
...
*Kopie f�r die Zielfunktion
EQUATIONS EqEY24_DES(set_ii_0,set_pss) Status�bergabe;
...
EQUATIONS EqEY25_DES(set_ii_0,set_pss) Status�bergabe;
