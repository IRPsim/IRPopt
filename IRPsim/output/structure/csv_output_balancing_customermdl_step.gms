...
LOOP((set_a, set_side_opt(set_side)),
    ...
    PUT Output_balancing_customermdl;

    PUT_UTILITY 'ren' / 'output/results/' set_a.tl:0 '.' set_optsteps.tl:0 '.' set_side_opt.tl:0  '.output_balancing_customermdl.csv';
    ...
    LOOP(set_t$set_t_store(set_t),
         ...
         PUT "par_out_Modelstat_customermodel" "("set_t.tl"); ";

         PUT "par_out_Solvestat_customermodel" "("set_t.tl"); ";

*-------------------------------------------------------------------------------
* ##Deklarieren Energieflüsse Stromlast##
*-------------------------------------------------------------------------------
         LOOP (set_load_DS_E$(set_pssOH(set_side_opt,set_load_DS_E) and set_pss_opt(set_load_DS_E)),
...
*-------------------------------------------------------------------------------
         LOOP (set_load_DS_W$(set_pssOH(set_side_opt,set_load_DS_W) and set_pss_opt(set_load_DS_W)),
...
*-------------------------------------------------------------------------------
         LOOP (set_load_DS_G$(set_pssOH(set_side_opt,set_load_DS_G) and set_pss_opt(set_load_DS_G)),
...
*-------------------------------------------------------------------------------
         LOOP (set_tech_DES_ES$(set_pssOH(set_side_opt,set_tech_DES_ES) and set_pss_opt(set_tech_DES_ES)),
         ...
         LOOP (set_tech_DES_ES$(set_pssOH(set_side_opt,set_tech_DES_ES) and set_pss_opt(set_tech_DES_ES)),
              ...
              PUT "par_out_E_fromEGrid_toES""("set_t.tl", ",set_side_opt.tl", ",set_tech_DES_ES.tl"); ";
                ...
                LOOP (set_tech_DES_ES$(set_pssOH(set_side_opt,set_tech_DES_ES) and set_pss_opt(set_tech_DES_ES)),
              PUT "par_out_E_fromCHP_toES""("set_t.tl", ",set_side_opt.tl", ",set_tech_DES_ES.tl"); ";
         );
         ...
         LOOP (set_tech_DES_ES$(set_pssOH(set_side_opt,set_tech_DES_ES) and set_pss_opt(set_tech_DES_ES) and par_X_BM_Sonnentank_DES_ES(set_tech_DES_ES)=0),
...
*-------------------------------------------------------------------------------
         LOOP (set_tech_DES_TS$(set_pssOH(set_side_opt,set_tech_DES_TS) and set_pss_opt(set_tech_DES_TS)),
...
*-------------------------------------------------------------------------------
         LOOP (set_tech_DES_NGB$(set_pssOH(set_side_opt,set_tech_DES_NGB) and set_pss_opt(set_tech_DES_NGB)),
...
*-------------------------------------------------------------------------------
         LOOP (set_tech_DES_EB$(set_pssOH(set_side_opt,set_tech_DES_EB) and set_pss_opt(set_tech_DES_EB)),
...
*-------------------------------------------------------------------------------
         LOOP (set_tech_DES_PV$(set_pssOH(set_side_opt,set_tech_DES_PV) and set_pss_opt(set_tech_DES_PV)),
...
*-------------------------------------------------------------------------------
         LOOP (set_tech_DES_HP$(set_pssOH(set_side_opt,set_tech_DES_HP) and set_pss_opt(set_tech_DES_HP)),
         ...
         LOOP (set_tech_DES_HP$(set_pssOH(set_side_opt,set_tech_DES_HP) and set_pss_opt(set_tech_DES_HP)),
              PUT "par_out_E_fromPV_toHP""("set_t.tl", ",set_side_opt.tl", ",set_tech_DES_HP.tl"); ";
                          ...
                          LOOP (set_tech_DES_HP$(set_pssOH(set_side_opt,set_tech_DES_HP) and set_pss_opt(set_tech_DES_HP)),
              PUT "par_out_E_fromCHP_toHP""("set_t.tl", ",set_side_opt.tl", ",set_tech_DES_HP.tl"); ";
         );
...
*-------------------------------------------------------------------------------
           LOOP (set_tech_DES_CHP$(set_pssOH(set_side_opt,set_tech_DES_CHP) and set_pss_opt(set_tech_DES_CHP)),
...
*-------------------------------------------------------------------------------
           LOOP (set_tech_DES_ST$(set_pssOH(set_side_opt,set_tech_DES_ST) and set_pss_opt(set_tech_DES_ST)),
...
*-------------------------------------------------------------------------------
         LOOP (set_tech_SS_WT$(set_pssOH(set_side_opt,set_tech_SS_WT) and set_pss_opt(set_tech_SS_WT)),
...
* ##Deklarieren Energieflüsse PV-Anlage##
*-------------------------------------------------------------------------------
         LOOP (set_tech_SS_PV$(set_pssOH(set_side_opt,set_tech_SS_PV) and set_pss_opt(set_tech_SS_PV)),
...
*-------------------------------------------------------------------------------
         LOOP (set_tech_SS_RH$(set_pssOH(set_side_opt,set_tech_SS_RH) and set_pss_opt(set_tech_SS_RH)),
...
* ##Deklarieren Energieflüsse Kraft-Wärme-Kopplungsanlagen##
*-------------------------------------------------------------------------------
         LOOP (set_tech_SS_CHP$(set_pssOH(set_side_opt,set_tech_SS_CHP) and set_pss_opt(set_tech_SS_CHP)),
...
*-------------------------------------------------------------------------------
         LOOP (set_tech_SS_RC$(set_pssOH(set_side_opt,set_tech_SS_RC) and set_pss_opt(set_tech_SS_RC)),
...
*-------------------------------------------------------------------------------
         LOOP (set_tech_SS_PHS$(set_pssOH(set_side_opt,set_tech_SS_PHS) and set_pss_opt(set_tech_SS_PHS)) ,
...
*-------------------------------------------------------------------------------
         LOOP (set_tech_SS_TPS$(set_pssOH(set_side_opt,set_tech_SS_TPS) and set_pss_opt(set_tech_SS_TPS)),
...
*-------------------------------------------------------------------------------
         ...
         PUT par_out_Modelstat_customermodel(set_t)"; ";

         PUT par_out_Solvestat_customermodel(set_t)"; ";
...
*-------------------------------------------------------------------------------
        ...
        LOOP (set_tech_DES_ES$(set_pssOH(set_side_opt,set_tech_DES_ES) and set_pss_opt(set_tech_DES_ES)),
              PUT par_out_E_fromEGrid_toES(set_t,set_side_opt,set_tech_DES_ES)"; ";
                ...
                LOOP (set_tech_DES_ES$(set_pssOH(set_side_opt,set_tech_DES_ES) and set_pss_opt(set_tech_DES_ES)),
              PUT par_out_E_fromCHP_toES(set_t,set_side_opt,set_tech_DES_ES)"; ";
         );
...
*-------------------------------------------------------------------------------
         ...
         LOOP (set_tech_DES_HP$(set_pssOH(set_side_opt,set_tech_DES_HP) and set_pss_opt(set_tech_DES_HP)),
              PUT par_out_E_fromPV_toHP(set_t,set_side_opt,set_tech_DES_HP)"; ";
                          ...
                          LOOP (set_tech_DES_HP$(set_pssOH(set_side_opt,set_tech_DES_HP) and set_pss_opt(set_tech_DES_HP)),
              PUT par_out_E_fromCHP_toHP(set_t,set_side_opt,set_tech_DES_HP)"; ";
         );
...
LOOP((set_a),
    ...
    PUT_UTILITY 'ren' / 'output/results/' set_a.tl:0 '.' set_optsteps.tl:0 '.output_balancing_customermdl.csv';
...
*-------------------------------------------------------------------------------
         LOOP ((set_fromPss,set_toPss)$(set_energyLink_opt('E',set_fromPss,set_toPss)),
              PUT "par_out_E_fromPss_toPss""("set_t.tl", ",set_fromPss.tl", ",set_toPss.tl"); ";
         );

        LOOP ((set_fromPss,set_toPss)$(set_energyLink_opt('W',set_fromPss,set_toPss)),
              PUT "par_out_W_fromPss_toPss""("set_t.tl", ",set_fromPss.tl", ",set_toPss.tl"); ";
         );

        LOOP ((set_fromPss,set_toPss)$(set_energyLink_opt('G',set_fromPss,set_toPss)),
              PUT "par_out_G_fromPss_toPss""("set_t.tl", ",set_fromPss.tl", ",set_toPss.tl"); ";
         );

                 LOOP ((set_fromPss,set_toPss)$(set_energyLink_opt('C',set_fromPss,set_toPss)),
              PUT "par_out_C_fromPss_toPss""("set_t.tl", ",set_fromPss.tl", ",set_toPss.tl"); ";
         );

        LOOP ((set_fromPss,set_toPss)$(set_energyLink_opt('B',set_fromPss,set_toPss)),
              PUT "par_out_B_fromPss_toPss""("set_t.tl", ",set_fromPss.tl", ",set_toPss.tl"); ";
         );

        LOOP ((set_fromPss,set_toPss)$(set_energyLink_opt('O',set_fromPss,set_toPss)),
              PUT "par_out_O_fromPss_toPss""("set_t.tl", ",set_fromPss.tl", ",set_toPss.tl"); ";
         );

        LOOP ((set_fromPss,set_toPss)$(set_energyLink_opt('RF',set_fromPss,set_toPss)),
              PUT "par_out_RF_fromPss_toPss""("set_t.tl", ",set_fromPss.tl", ",set_toPss.tl"); ";
         );

        LOOP ((set_fromPss,set_toPss)$(set_energyLink_opt('L',set_fromPss,set_toPss)),
              PUT "par_out_L_fromPss_toPss""("set_t.tl", ",set_fromPss.tl", ",set_toPss.tl"); ";
         );

        LOOP ((set_fromPss,set_toPss)$(set_energyLink_opt('HC',set_fromPss,set_toPss)),
              PUT "par_out_HC_fromPss_toPss""("set_t.tl", ",set_fromPss.tl", ",set_toPss.tl"); ";
         );

       LOOP ((set_fromPss,set_toPss)$(set_energyLink_opt('PR',set_fromPss,set_toPss)),
              PUT "par_out_PR_fromPss_toPss""("set_t.tl", ",set_fromPss.tl", ",set_toPss.tl"); ";
         );

       LOOP ((set_fromPss,set_toPss)$(set_energyLink_opt('NR',set_fromPss,set_toPss)),
...
*-------------------------------------------------------------------------------
        LOOP (set_power$set_power_opt(set_power),
...
*-------------------------------------------------------------------------------
         ...
         LOOP (set_tech_DES_TS$set_pss_opt(set_tech_DES_TS),
...
*-------------------------------------------------------------------------------
         LOOP (set_tech_DES_ES$(set_pss_opt(set_tech_DES_ES) and not set_pss_BM(set_tech_DES_ES)) ,
...
*-------------------------------------------------------------------------------
         LOOP (set_load_DS_W$set_pss_opt(set_load_DS_W),
              PUT "par_out_W_DS_load_cov""("set_t.tl", ",set_load_DS_W.tl"); ";
         );

*-------------------------------------------------------------------------------
* ##Deklarieren KPI Bilanzierung####
*-------------------------------------------------------------------------------
         LOOP (set_tech_DES$(set_pss_opt(set_tech_DES) and not set_pss_BM(set_tech_DES)),
