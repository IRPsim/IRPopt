...
* - description: Bitte legen Sie hier fest, ob eine Energieverbindung von der Kraft-W�rme-Kopplungsanlage zu folgendem Prosumstorer (Technologie, Last, Netz, Markt etc.) bestehen soll
* - type: Boolean
* - identifier: Energieverbindung von Kraft-W�rme-Kopplungsanlage zu Prosumstorer
* - domain: [0|1]
* - color: DarkCyan
